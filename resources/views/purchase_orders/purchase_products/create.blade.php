...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Add Purchase Product</div>
                    <div class="card-body">
                        <form class="row g-3" action="{{ route('purchase_orders.purchase_products.store', ['purchase_order' => $purchase_order]) }}" method="post">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ route('purchase_orders.purchase_products.index', ['purchase_order' => $purchase_order]) }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
